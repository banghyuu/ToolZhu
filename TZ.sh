...
echo
echo $cy"==================="$pur" ==================="
echo $me"█"$bi"  CopyRight  : Mr Zhu      "$me"          █"
echo $ku"█"$bi"  WhatsApp: 0859175727510"$ku"            █"
echo $bi"█"$bi"  Gmail   :  banghyuu40@gmail.com"$bi"    █"
echo $i"█"$bi"  Team :  IndonesianHazywebTeam"$i"      █"
echo $me"==================="$ku" ==================="
echo
...
echo
echo $pu"╭─["$i"Pilih sesuai keinginanmu cok"$pu"]"
read -p"╰─> : " pil
